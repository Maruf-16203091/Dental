...
if (isset($_POST['btn'])) {
    ...
    if (!empty($name) && !empty($email) && !empty($phone) && !empty($password)) {
				...
				$sql = "insert into add_reciptionists(reciptionist_name,reciptionist_email,reciptionist_phone,password,reciptionist_img_url,reciptionist_active_status)values(?,?,?,?,?,?)";
...
<!---  Contents Starts ------>
   ...
   <div id="page-inner">
       <div class="row">
           <div class="col-md-12">
            <h2>Add Receptionist Information</h2>   
