...
if (isset($_POST['btn'])) {
    ...
    if (!empty($name) && !empty($email) && !empty($phone) && !empty($password)) {
				$sql = "update tbl_add_doctor set doctor_name='$name',doctor_email='$email',doctor_phone='$phone',password='$password',doctor_img_url='$image_url' where doctor_id='$id'";
                                ...
                                <div class="col-md-8 col-md-offset-2">
                                    ...
                                    <form role="form" method="post" enctype="multipart/form-data">
                                        <div class="form-group">
                                            <label>Name:</label>
                                            <input type="text" class="form-control" name="name" value="<?php echo $data['doctor_name']; ?>"/>                                             
                                        </div> 
										
										<div class="form-group">
                                            <label>Email:</label>
                                            <input type="email" class="form-control" name="email" value="<?php echo $data['doctor_email']; ?>"/>                                             
                                        </div>	
										
										<div class="form-group">
                                            <label>Phone Number:</label>
                                            <input type="text" class="form-control" name="phone" value="<?php echo $data['doctor_phone']; ?>"/>                                             
                                        </div>		
